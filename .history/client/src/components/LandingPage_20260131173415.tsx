    ...
    >
      <div
          className="
            pointer-events-none
            absolute inset-0
            bg-[radial-gradient(circle_at_50%_20%,rgba(255,255,255,0.25),transparent_60%)]
          "
        />
      ...
      <div className="absolute bottom-8 right-8 z-10 flex flex-col items-end gap-1 text-right hidden md:flex">
        <div className="flex flex-col items-end text-white/70">
          <p className="publicSans-text text-xs leading-[15px] tracking-[1.2px]">COORD: 40.6935° N, -73.9854° W</p>
          <p className="publicSans-text text-xs leading-[15px] tracking-[1.2px]">RENDER_ENGINE: REACT.V18</p>
          <p className="publicSans-text text-xs leading-[15px] tracking-[1.2px]">SESSION_ID: GOLDEN RECORD</p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="w-full h-12 border-b border-[#BA76FF]/30 flex items-center justify-between px-6 bg-white/10 shrink-0 relative z-30 select-none">
                    <span className="publicSans-text text-[#BA76FF] text-[10px] tracking-widest">
                ...
                <div className="flex-1 flex flex-col items-center p-8 md:p-12 gap-8 w-full h-full justify-center relative">
                    ...
                    <motion.h1 
                        className="tk-din-condensed text-[#BA76FF] text-7xl md:text-9xl text-center leading-none drop-shadow-lg break-words w-full select-none"
                    >
                        {slide.title}
                    </motion.h1>
                    ...
                    <div className="relative max-w-[512px] w-full">
                        ...
                        <p className="publicSans-text text-black text-sm uppercase tracking-[0.35px] leading-[22px] text-justify select-none">
                        {slide.description}
                        </p>
                    </div>
                    ...
                    <div className="pt-4">
                        ...
                        >
                            ...
                            <div className="relative z-10 w-full flex items-center justify-center gap-3 px-4">
                                <span className="publicSans-text text-xs tracking-[1.2px] uppercase">
                                {slide.actionText}
                                </span>
                                <span className="publicSans-text text-xs group-hover:translate-x-1 transition-transform">{`>>`}</span>
                            </div>
                        </motion.button>
                    </div>
                </div>
