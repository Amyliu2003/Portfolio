...
const THEME = {
  fontTitle: "font-['DIN_Condensed',_sans-serif] uppercase tracking-[-3px]",
  fontHeader: "font-['DIN_Alternate',_sans-serif] uppercase tracking-normal font-bold",
  fontBody: "font-['Public_Sans',_sans-serif] font-normal tracking-wide",
  fontDecorative: "font-['Yarndings_12',_sans-serif] uppercase tracking-[1px]",
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed inset-0 z-[200] flex flex-col overflow-y-auto bg-gradient-to-b from-[#181a4b] to-[#172fab]"
      >
        ...
        {`
          ...
          @font-face {
             font-family: 'Yarndings_12';
             src: url('https://db.onlinewebfonts.com/t/2c8c634676527582531835787c8808ce.woff2') format('woff2');
          }
        `}
        </style>
        ...
        <div className="w-full max-w-[1184px] mx-auto p-6 md:p-12 mt-12 mb-20 relative">
          ...
          <div className="flex flex-col items-start w-full mb-12">
              ...
              <div className="flex flex-col md:flex-row items-end justify-between w-full border-b-0">
                 ...
                 <div className="flex flex-col">
                     <p className={`text-[#ba76ff] text-[14px] tracking-[1.4px] leading-[20px] mb-1 ${THEME.fontBody}`}>
                     ...
                     {isEditing ? (
                        ...
                        <h1 className={`text-[72px] text-[var(--accent)] leading-none tracking-[-3px] uppercase ${THEME.fontTitle}`}>
                            {project.title}
                        </h1>
                      )}
                 </div>
          ...
          <div className="w-full h-[100vh] relative mb-24 bg-[rgba(255,255,255,0.05)] p-px">
          ...
          <div className="w-full flex items-center justify-center mt-32 mb-12 opacity-60">
               <div className={`text-[20px] text-white tracking-[1px] ${THEME.fontDecorative}`}>
                  dedeededede edededeed ededeedede 
              </div>
          </div>
