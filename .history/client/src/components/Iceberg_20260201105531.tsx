...
export const Iceberg: React.FC = () => {
  return (
    <div className="absolute w-full h-[100vh] pointer-events-none overflow-visible">
      ...
      {/* TOP ICEBERG */}
      <div className="absolute -translate-x-1/2 z-10" style={{top: "-50px",left: "20%"}}>
        <svg
      ...
      <div className="absolute left-1/2 max-w-[1000px] -translate-x-1/2 scale-x-[-1] opacity-40 z-0">
        <svg
