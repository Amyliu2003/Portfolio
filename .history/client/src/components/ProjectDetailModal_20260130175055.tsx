            ...
            <div className="w-full">
              ...
              {isEditing ? (
                <input
                  ...
                  className={`w-full Alegreya_Sans-text bg-white/10 border border-[#333] text-white px-4 py-2 text-4xl md:text-6xl font-black italic uppercase leading-none ${THEME.font} focus:border-[#BA76FF] outline-none mb-4`}
                />
              ) : (
                <h1
                  ...
                  <div key={section.id || index} className="border border-[#333] bg-transparent">
                    {isEditing ? (
                       ...
                       <div>
                          ...
                          >
                             <h4 className="text-lg Alegreya_Sans-text md:text-xl font-bold uppercase tracking-tight">
                                {section.title}
                             </h4>
                             <motion.span
