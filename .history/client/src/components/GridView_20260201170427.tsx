        ...
        <Masonry gutter="3rem">
          {items.map((item) => (
            <motion.div
              ...
              className="relative group cursor-pointer radius-8 bg-[#172067] border border-[#333] hover:border-[var(--accent)] transition-all duration-300 bg-white/5 flex flex-col"
              whileHover={{ y: -5 }}
            >
              {/* Image Area */}
