...
export const Iceberg: React.FC = () => {
  return (
    <div className="absolute w-full h-[150vh] pointer-events-none overflow-visible">
      
      {/* TOP ICEBERG */}
      <div className="absolute -translate-x-1/2 z-10" style={{top: "-200px",left: "20%"}}>
        <svg
          viewBox="0 0 1110 509"
          xmlns="http://www.w3.org/2000/svg"
          className="w-full aspect-[1110/509]"
          style={{ width: "1000px", height: "500px", position: "absolute", top: "-100px",left: "50%" }}
        >
          <path
      ...
      <div className="absolute left-1/2 max-w-[1000px] -translate-x-1/2 scale-x-[-1] opacity-40 z-0 " style={{ top: "50px",left: "20%" }}>
        <svg
