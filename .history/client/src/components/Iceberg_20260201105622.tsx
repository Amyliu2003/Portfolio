...
export const Iceberg: React.FC = () => {
  return (
    <div className="absolute w-full pointer-events-none overflow-visible">
      ...
      <div className="absolute left-1/2 max-w-[1000px] -translate-x-1/2 scale-x-[-1] opacity-40 z-0 " style={{ top: "150px",left: "20%" }}>
        <svg
