...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="flex-shrink-0 w-full px-8 py-8 sm:py-10 z-10 flex flex-col lg:flex-row justify-between items-end border-b border-white/20">
      {/* LEFT: TITLE BLOCK */}
      <div className="flex flex-col items-start gap-4">
        ...
        <div className="flex items-center gap-1 text-white/80 publicSans-text italic uppercase tracking-[1.4px] text-xs sm:text-sm">
            <span className="yarding-text hidden sm:block ">siera@2149 |</span>
      ...
      <div className="flex flex-col items-start sm:items-end gap-2 mt-4 md:mt-0">
         ...
         {/* Work Label */}
         <div className="text-right tk-din-condensed text-white text-3xl md:text-4xl  uppercase tracking-[0.9px] leading-none">
             Work / 22-26
         </div>
