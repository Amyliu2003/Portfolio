你已经改过来了 是这个有问题： import React from "react";

export const Iceberg: React.FC = () => {
  return (
    <div className="relative w-full h-[120vh] pointer-events-none overflow-visible">
      
      {/* TOP ICEBERG */}
      <div className="absolute top-[10%] left-1/2 w-[70%] max-w-[1000px] -translate-x-1/2 z-10">
        <svg
      ...
      <div className="absolute top-[45%] left-1/2 w-[70%] max-w-[1000px] -translate-x-1/2 scale-x-[-1] opacity-40 z-0">
        <svg
