              ...
              <div className="p-6 flex flex-col gap-4">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {item.skills.split("•").map((skill, idx) => (
                    <span
                      key={idx}
                      className="border border-[#333] px-3 py-1.5 text-[10px] publicSans-text font-bold uppercase tracking-wider text-[#888] hover:text-white hover:border-white transition-colors"
                    >
                      {skill.trim()}
                    </span>
                  ))}
