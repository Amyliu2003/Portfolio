          ...
          {hoveredItem.type === "special" ? (
            ...
            >
              <div className="w-full mb-2 bg-black relative flex items-center justify-center">
                ...
                <div className="absolute inset-0 bg-black/10 bg-[repeating-linear-gradient(0deg,transparent_0px,transparent_3px,rgba(0,0,0,0.5)_3px,rgba(0,0,0,0.5)_6px)] bg-[length:100%_6px] pointer-events-none"></div>
              </div>
