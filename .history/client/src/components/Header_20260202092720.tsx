    ...
    <header className="flex-shrink-0 w-full px-8 py-8 sm:py-10 z-10 flex flex-col md:flex-row justify-between items-end border-b border-white/20">
      ...
      <div className="flex flex-col items-start gap-4">
        <div className="flex items-baseline -space-x-2">
            <h1 className="text-white text-4xl sm:text-5xl font-['Underdog'] uppercase tracking-[1.8px] leading-none">
                Amy
            </h1>
            <h1 className="text-[#BA76FF] text-4xl sm:text-5xl font-['Warnes'] uppercase tracking-[1.8px] leading-none">
                LiuSiyan
            </h1>
        </div>
