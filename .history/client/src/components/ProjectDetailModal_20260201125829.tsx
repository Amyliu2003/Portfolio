  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        style={{ background: "linear-gradient(rgba(186, 118, 255, 0.3) 0%, rgba(186, 118, 255, 0) 8%), linear-gradient(rgb(213, 220, 217) 0%, rgb(131, 193, 230) 20%, rgb(29, 93, 229) 40%, rgb(23, 47, 171) 56%, rgb(24, 26, 75) 80%)" }}
      >
