...
export const initialProjects: ProjectItem[] = Array.from({ length: 15 }, (_, i) => {
  ...
  // 2. 100 Days of OC's (?) Artififacts
  if (id === 5) {
    return {
      id,
      idStr,
      projectLabel,
      type: "special",
      title: "100 Days of OC's (?) Artififacts",
      time: "WINTER 2025",
      skills: "JavaScript • p5.js • Creative Coding",
      role: "Creative Coder",
      description:
        "A summer-long personal challenge to code daily for 100 days, exploring generative art, interactive visuals, and algorithmic design using JavaScript and p5.js. Each day presented a new concept or technique, fostering creativity and technical growth through consistent practice and experimentation.",
      image: 100daysTitle,
      link: "https://amyliu100days.github.io/",
      githubLink: " #github-05",
    };
  } 
