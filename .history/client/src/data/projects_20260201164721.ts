...
import attractivePoliticsTitle from "../assets/attractivePolitics.png";
...
export const initialProjects: ProjectItem[] = Array.from({ length: 15 }, (_, i) => {
  ...
  if (id === 11) {
    return {
      ...
      time: "SPRING 2025",
      skills: "p5.js • Arduino • Installation",
      role: "Developer",
      description:
        "An ambient installation simulating real-time weather conditions from a chosen location. Using p5.js for visual rendering and Arduino for physical effects, the piece creates an immersive experience that blends digital and physical elements to evoke the sensation of observing weather through a window.",
