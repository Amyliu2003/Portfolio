    ...
    return {
      ...
      contentBlocks: [
        ...
        },
        {
            ...
            caption: "The installation at NYU IMA/ITP Spring 2025 Show"
        },
        {
            id: "blk-6",
            type: "quote",
            text: "This “roommate” was never invited; it arrived as an assumption—an entity that had entered the home without consent.",
            author: "The Uninvited Roommate"
        },
        {
            id: "blk-7",
            type: "split",
            title: "Reflection: Agency in the AI Era",
            text: "Much like these uninvited roommates, AI systems built on semantic databases are gradually embedding themselves into how we consume information—from social media to content-sharing platforms, and eventually into daily life and education. In this context, the only agency we retain may be the choice of whom—or what—we live with under the same roof.",
