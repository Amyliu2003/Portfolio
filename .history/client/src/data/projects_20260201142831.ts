...
export const initialProjects: ProjectItem[] = Array.from({ length: 15 }, (_, i) => {
  ...
  if (id === 5) {
    return {
      ...
      description:
        "A semesrer-long personal challenge to code daily for 100 days, exploring generative art, interactive visuals, and algorithmic design using JavaScript and p5.js. Each day presented a new concept or technique, fostering creativity and technical growth through consistent practice and experimentation.",
      image: CDaysTitle,
