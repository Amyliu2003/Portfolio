...
export const initialProjects: ProjectItem[] = Array.from({ length: 15 }, (_, i) => {
  ...
  if (id === 3) {
    return {
      ...
      projectLabel,
      type: "special",
      title: "SmartChip AI Assistant",
      time: "AUG 2025",
      skills: "Python • NLP • Hardware",
      role: "AI Developer • Hardware Engineer",
      description:
        "Developed a voice-activated AI assistant on a Raspberry Pi using Python and NLP libraries. Integrated speech recognition, intent parsing, and text-to-speech for interactive responses. Designed a custom PCB for microphone and speaker connectivity, housed in a 3D-printed enclosure. Focused on low-latency performance and offline capabilities.",
