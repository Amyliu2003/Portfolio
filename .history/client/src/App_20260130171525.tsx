...
useEffect(() => {
  const section = appSectionRef.current;
  if (!section) return;
  ...
  return (
    <div
      className="h-screen w-full overflow-y-auto snap-y snap-mandatory scroll-smooth font-['Tinos',_serif] selection:bg-[#BA76FF] selection:text-white absolute inset-0 bg-black/20 bg-[linear-gradient(transparent_50%,rgba(0,0,0,0.5)_50%)] bg-[length:100%_4px] pointer-events-none"></div>
"
      style={{
